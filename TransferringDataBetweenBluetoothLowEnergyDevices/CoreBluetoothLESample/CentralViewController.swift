...
extension CentralViewController: CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic, error: Error?) {
        ...
        // call function
        //        appDelegate.showLocalNotification(id: "DidUpdateValue",title: "Peripheral did update value from grave!",body: "")
        ...
        appDelegate.showLocalNotification(id: "DidUpdateValue",title: "Peripheral did update value from grave!",body: "\(stringFromData)")
    ...
    func centralManager(_ central: CBCentralManager, willRestoreState dict: [String : Any]) {
        ...
        guard let appDelegate: AppDelegate = UIApplication.shared.delegate as? AppDelegate else { return }
        appDelegate.showLocalNotification(id: "willrestorestate",title: "Manager will restore state",body: "")
        if let peripheralsObject = dict[CBCentralManagerRestoredStatePeripheralsKey] {
            ...
            if peripherals.count > 0 {
                for i in 0 ..< peripherals.count {
                    ...
                    // call function
                    appDelegate.showLocalNotification(id: "willrestorestate2",title: "Manager will restore state",body: "")
